...
import { View, AppRegistry, StyleSheet, Dimensions, TouchableOpacity, Modal,
AsyncStorage, Keyboard, Alert } from 'react-native';
import { Text, Icon, FormInput, CheckBox, Divider} from 'react-native-elements';
          ...
          <View style={styles.container}>
              <View style={styles.contentContainer}>
                <View style = {styles.header}>
                    ...
                    <Icon  name='wallet'  type='material-community' size = {35} color = "green"/>
                </View>
                <View style = {styles.main}>
                  <FormInput placeholder = "Insert new wallet name" containerStyle = {[styles.input, {borderBottomColor : this.state.nameBorderColor}]}  inputStyle = {{width : width * 0.8 }}
                  ...
                  <FormInput placeholder = "Insert current account balance" containerStyle = {[styles.input, {borderBottomColor : this.state.balanceBorderColor}]}
                    inputStyle = {{width : width * 0.8 }} underlineColorAndroid="transparent" keyboardType = "numeric"  selectionColor = "orangered"
                ...
                <TouchableOpacity activeOpacity={0.5} onPress = {() => this.setErrorDialogVisible(false)}>
                  <Text  style = {{color:"green", fontSize : 22 }}>CLOSE</Text>
                </TouchableOpacity>

                <Divider  style = {{width : 20, backgroundColor : "transparent"}}/>

                <TouchableOpacity activeOpacity={0.5} onPress = {this.createNewWallet.bind(this)}>
